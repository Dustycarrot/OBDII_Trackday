...
//4295/2156256/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "E-L9637D" (originalName "E-L9637D")
	...
	(compDef "E-L9637D" (originalName "E-L9637D") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "RX") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "LO") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "VCC") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "TX") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "LI") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "K") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "E-L9637D"))
		...
		(attr "Mouser Part Number" "511-E-L9637D")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/E-L9637D?qs=lrqjml%252Bjt8d%2FUlnJz0Tlgg%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "E-L9637D")
		(attr "Description" "Monolithic bus driver with ISO 9141 interface")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/l9637.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "E-L9637D.stp")
